...
class _PickupHistoryScreenState extends State<PickupHistoryScreen> {
  ...
  List<_PickupEntry> get _filtered => _filterStatus == null
      ? _pickups
      : _pickups.where((p) => p.status == _filterStatus).toList();
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                ...
                _FilterChip(
                  label: 'Pending',
                  isActive: _filterStatus == PickupStatus.pending,
                  onTap: () =>
                      setState(() => _filterStatus = PickupStatus.pending),
                ),
                _FilterChip(
                  label: 'Completed',
                  isActive: _filterStatus == PickupStatus.completed,
                  onTap: () =>
                      setState(() => _filterStatus = PickupStatus.completed),
                ),
                _FilterChip(
                  label: 'Cancelled',
                  isActive: _filterStatus == PickupStatus.cancelled,
                  onTap: () =>
                      setState(() => _filterStatus = PickupStatus.cancelled),
                ),
              ],
            ),
          ),
          Expanded(
            child: _filtered.isEmpty
                ? const EmptyStateWidget(
                    ...
                    subtitle:
                        'Schedule your first waste collection to start earning credits.',
                  )
                : ListView.separated(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isActive ? AppColors.forestGreen : AppColors.borderLight,
          ),
        ),
        child: Center(
          child: Text(
